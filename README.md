...
Для работы JWT необходимо создать пару приватного и публичного ключей:
```
...
# 📑 Документация API (Auth Service)

Базовый префикс всех эндпоинтов: http://localhost:8080/users

## 1. Публичные эндпоинты (Анонимный доступ)
...
Выдает Access/Refresh токены и устанавливает их в HttpOnly Cookies.
*   URL: /login/
*   Метод: POST
*   Формат: x-www-form-urlencoded (OAuth2 standard)
...
## 2. Защищенные эндпоинты (Требуется JWT)
*Требуется заголовок Authorization: Bearer <access_token> или наличие Cookies.*

### 👤 Информация о профиле
*   URL: /me/
*   Метод: GET
*   Ответ: Данные о текущем пользователе и время входа.

### 🚪 Выход из системы (Logout)
*   URL: /logout/
*   Метод: POST
*   Действие: Блокирует текущий токен в Redis, удаляет сессию из БД и очищает Cookies.
